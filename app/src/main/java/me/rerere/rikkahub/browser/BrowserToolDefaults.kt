...
object BrowserToolDefaults {
    ...
    //
    // The issue asked for "unlimited", but a truly unbounded browser task can block
    // generation and burn battery silently — every tool must have a hard timeout. Instead of
    // unlimited we expose a generous
