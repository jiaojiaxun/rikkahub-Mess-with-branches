...
private fun WebViewHost(
    ...
    val webView = remember {
        ...
        WebView(ctx).apply {
            ...
            // device: innerHeight=774 but 100vh=0). MATCH_PARENT here lets the real
            // Compose-driven size flow through instead.
            ...
            // Keep every render-related setting (mixedContentMode, hardware layer, autoplay,
            // UA strip, file:// access) in configureWebViewForRikka so all visible browser
            // instances behave identically. See BrowserWebViewConfig.kt for the why.
