 ...
 * `mcp_get` and `mcp_list` tool results, the in-app approval prompt, and any future
 * debug log of the active MCP config.
 *
 ...
 * entry is zero, the cost of leaking a token in an approval prompt is a security incident.
 */
