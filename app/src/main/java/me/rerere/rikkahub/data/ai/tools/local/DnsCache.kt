...
/**
 * Tiny in-memory hostname → resolved-IP cache with a fixed TTL for network-capable tools,
 * avoiding repeated DNS round-trips while a request sequence targets the same host.
 *
