...
// Without the bound, a stalled OCR call can block later messages in the same conversation;
// this timeout prevents that failure mode.
...
object OcrTransformer : InputMessageTransformer, KoinComponent {
    ...
    suspend fun performOcr(part: UIMessagePart.Image): String = runCatching {
        ...
        // Let a real cancellation propagate instead of swallowing
