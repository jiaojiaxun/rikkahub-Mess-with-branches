...
interface MessageNodeDAO {
    ...
    @RawQuery
    suspend fun getUsageSummaryRaw(query: SupportSQLiteQuery): List<UsageSummaryRow>
}
...
private val USAGE_SUMMARY_SQL = SimpleSQLiteQuery(
    "SELECT mn.conversation_id AS conversationId, " +
        ...
        "GROUP BY mn.conversation_id, modelId, day"
)

suspend fun MessageNodeDAO.getUsageSummary(): List<UsageSummaryRow> =
    getUsageSummaryRaw(USAGE_SUMMARY_SQL)
