...
class GeminiOAuthManager(
    ...
    companion object {
        ...
        // OAuth credentials are injected at build time and must never be committed to source.
        // Supply geminiOAuthClientId/geminiOAuthClientSecret Gradle properties (or the matching
        // environment variables) for builds that enable Gemini OAuth login.
