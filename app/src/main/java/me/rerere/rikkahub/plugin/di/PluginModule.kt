...
val pluginModule = module {
    ...
    // Loader uses only app-scoped HTTP and settings services; removed memory-bank/scheduler hooks
    // stay outside the slim build boundary.
    single { PluginLoader(androidContext(), get<OkHttpClient>(), settingsStore = get<SettingsStore>()) }
