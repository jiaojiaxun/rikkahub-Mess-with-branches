 ...
 *  3. dispatches the test prompt + the skill body inlined as the user message
 *  4. waits up to [timeoutMs] (default 2 min) for the generation flow to settle
 *  5. harvests the last assistant message's text + image parts
 *  6. deletes the temporary conversation and drops the session
 *
