...
leadingContent = { Icon(HugeIcons.Sun01, null) },
            ...
            item("advancedServices") {
                var advancedExpanded by rememberSaveable { mutableStateOf(false) }
                CollapsibleSettingsDrawer(
                    expanded = advancedExpanded,
                    onToggle = { advancedExpanded = !advancedExpanded },
                    title = { Text(stringResource(R.string.setting_page_advanced_services)) },
                    description = { Text(stringResource(R.string.setting_page_advanced_services_desc)) },
                ) {
                    CardGroup(
                        modifier = Modifier
                            .fillMaxWidth()
...
@Composable
private fun CollapsibleSettingsDrawer(
    expanded: Boolean,
    onToggle: () -> Unit,
