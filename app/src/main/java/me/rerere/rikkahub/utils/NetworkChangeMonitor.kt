...
/**
 * Phase-17 stability fix — when the app is backgrounded and Android changes the active
 * default network OR
 ...
 * MCP manager, skill URL importer) can call [register] to opt in.
...
object NetworkChangeMonitor {
     ...
     * default-network handoff. A DNS cache may keep using a cached IP for a short request
     * sequence, but a Wi-Fi ↔
        ...
        synchronized(this) {
            ...
            val cb = object : ConnectivityManager.NetworkCallback() {
                ...
                override fun onLost(network: Network) {
                    ...
                    // the same physical network reappears with the same handle id.
                ...
                // DNS regression we're guarding against is a network-handoff symptom, which
                // onAvailable + onLost catch correctly.
            }
            try {
